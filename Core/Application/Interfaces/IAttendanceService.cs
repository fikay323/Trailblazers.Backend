...
namespace Trailblazers.Backend.Core.Application.Interfaces
{
    public interface IAttendanceService
    {
        ...
        Task<AttendanceRecordDto> ClockOutAsync(Guid studentId, ClockInRequestDto request);
        ...
        Task<byte[]> GenerateAttendanceCsvReportAsync(DateOnly? startDate, DateOnly? endDate, Guid? studentId, string? searchTerm);
    }
}
